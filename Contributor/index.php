...
<body >
		...
		<h1 style="font-family: fantasy; color: blue">Contributor</h1>
		
	<center>
		<h3 class="center">
			Welcome Contributor: <?php echo $_SESSION['user']['fullname']; ?>
				...
				if($result ->num_rows > 0){
					while($row = mysqli_fetch_assoc($result)){
							...
							<tr>
								...
								<td>
									<a href="index.php?post_id=<?php echo $row['post_id']; ?>">Edit</a> | <a href="post_process.php?action=delete&post_id=<?php echo $row['post_id']; ?>">Delete</a>
								</td>
