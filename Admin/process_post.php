...
require_once("../include/connection.php");
	...
	if(isset($_REQUEST['update_post'])){
		...
		if(mysqli_stmt_execute($prepared_stmt)){
				header("location:index.php?message=New post has been updated successfully!...&color=green");
		}else{
			header("location:index.php?message=New post has not been updated!...&color=red");	
		}
   ...
   <!--  <div class="button"> -->
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action'] == "delete" ){
		...
		if(mysqli_stmt_execute($prepared_stmt)){
				header("location:index.php?message=has been deleted successfully!...&color=green");
		}else{
			header("location:index.php?message=has not been deleted!...&color=red");	
		}
